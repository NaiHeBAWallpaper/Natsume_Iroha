...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/Walkthrough.flac';
let bgmvolume = 0;
let bgm;
...
const HITBOX = {
	headpat: { xMin: 620, xMax: 1080, yMin: 100, yMax: 420 },
	voiceline: { xMin: 1050, xMax: 1780, yMin: 600, yMax: 1250 }
};
